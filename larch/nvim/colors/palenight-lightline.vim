...
let s:p_black = ["#282828", 235, 0]

let s:p.normal.left     = [ [ s:p_black, s:p_purple, 'bold' ], [ s:p_purple, s:p_menu_grey ] ]
...
let s:p.insert.left     = [ [ s:p_black, s:p_blue, 'bold' ], [ s:p_blue, s:p_menu_grey ] ]
let s:p.insert.right    = copy(s:p.insert.left)
let s:p.insert.middle   = copy(s:p.normal.middle)

let s:p.visual.left     = [ [ s:p_black, s:p_yellow, 'bold' ], [ s:p_yellow, s:p_menu_grey ] ]
let s:p.visual.right    = copy(s:p.visual.left)
let s:p.visual.middle   = copy(s:p.normal.middle)

let s:p.replace.left    = [ [ s:p_black, s:p_green, 'bold' ], [ s:p_green, s:p_menu_grey ] ]
...
let s:p.tabline.tabsel  = [ [ s:p_black, s:p_dark_red ] ]
