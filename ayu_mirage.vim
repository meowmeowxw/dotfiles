" Normal mode
" (Dark)
let s:N1 = [ '#0C1014' , '#90d657' , 0   , 114 ] " guifg guibg ctermfg ctermbg
let s:N2 = [ '#BBE67E' , '#464745' , 114 , 0   ] " guifg guibg ctermfg ctermbg
let s:N3 = [ '#E6E1CF' , '#0C1014' , 15  , 0   ] " guifg guibg ctermfg ctermbg

" Insert mode
let s:I1 = [ '#0C1014' , '#80D4FF' , 0   , 80  ] " guifg guibg ctermfg ctermbg
let s:I2 = [ '#80D4FF' , '#464745' , 80  , 0   ] " guifg guibg ctermfg ctermbg
let s:I3 = [ '#E6E1CF' , '#0C1014' , 15  , 0   ] " guifg guibg ctermfg ctermbg

" Visual mode
let s:V1 = [ '#0C1014' , '#FFAE57' , 0   , 173 ] " guifg guibg ctermfg ctermbg
let s:V2 = [ '#FFAE57' , '#464745' , 173 , 0   ] " guifg guibg ctermfg ctermbg
let s:V3 = [ '#E6E1CF' , '#0C1014' , 15  , 0   ] " guifg guibg ctermfg ctermbg
